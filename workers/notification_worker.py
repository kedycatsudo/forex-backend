...
async def _process_notification_message(message: dict[str, Any]) -> None:
    await asyncio.sleep(0.2)
    # raise ValueError("simulated notification processing failure")
            ...
            try:
                ...
                with bind_correlation(incoming_request_id) as corr:
                    try:
                        ...
                        await _process_notification_message(message)
